...
class EOVWidget(QWidget):
    ...
    def button_clicked_showmap(self):
        ...
        str_output_datay = str("WGS84 λ coords: " + wgs84y)
        str_output_datax = str("WGS84 φ coords: " + wgs84x)
        
        wgsurl = f"https://www.google.hu/maps/?q=loc:{wgslist[2]},{wgslist[1]}&t=k&hl=hu&z=100"
